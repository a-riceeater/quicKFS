...
TLS protects transport, while authentication is a separate protocol request. The development shared token is the current trust boundary and is not adequate for Internet deployment.
